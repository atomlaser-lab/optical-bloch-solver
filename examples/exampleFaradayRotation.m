...
th = 0;
ph = 0;
op.setMagneticField(2.85,...                  %Magnetic field in Gauss
...
%
op.initPop(8) = 1;
op.integrate(1e-9,2e-6);    %Integrate using time step (first argument) up to a given time (second argument) assuming constant fields
